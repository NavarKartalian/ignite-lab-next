...
import { AiFillGithub, AiOutlineGoogle, AiOutlineTwitter } from 'react-icons/ai';
        ...
        <div className="w-full flex items-center justify-between mt-10 lg:mt-20 mx-auto flex-col lg:flex-row lg:max-w-[1116px] lg:px-4">
          ...
          <div className="p-8 mt-8 bg-gray-700 border border-gray-500 rounded w-full md:w-auto lg:mt-0">
            ...
            <div className="flex flex-col gap-4">
              <LoginButton icon={<AiFillGithub size={24} />} type='github' />
              <LoginButton icon={<AiOutlineGoogle size={24} />} type='google' />
              <LoginButton icon={<AiOutlineTwitter size={24} />} type='twitter' />
            </div>
          </div>
        </div>
